  ...
  const adminPanel = [
    ...
    },
    {
      ...
      options: [
        ...
        { name: "Update Coupon", url: "/admin/coupon/update" },
      ],
    },
  ];
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed h-10 w-10 top-24 right-6 md:top-2 md:right-12 z-50 lg:hidden p-2 text-white bg-secondary border border-mywhite rounded-lg flex items-center justify-center"
      >
      ...
      <div
        ...
        } fixed lg:relative top-0 left-0 w-72 bg-secondary text-mywhite h-full p-4 z-40 transition-transform duration-300 ease-in-out lg:translate-x-0  lg:w-72`}
      >
